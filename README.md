...
The dev container will build, and all necessary PostgreSQL databases (pg-general, pg-mehmet, pg-ali, etc.) will start automatically as defined in the docker-compose.yml.
